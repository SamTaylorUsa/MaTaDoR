 ...
 text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		...
		},
		{
			...
			{text = tostring(settings.num_msg_max), callback_data="BlackTeaM"},
		...
		},
		{
			...
			{text = tostring(settings.set_char), callback_data="BlackTeaM"},
		...
		},
		{
			...
			{text = tostring(settings.time_check), callback_data="BlackTeaM"},
...
local lang = redis:get(hash) 
 ...
 text = '_Welcome To_ *Group Settings*'
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = "➣ Group Welcome", callback_data='BlackTeaM'}, 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = "➣ قفل ویرایش", callback_data='BlackTeaM'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "➣ قفل لینک", callback_data='BlackTeaM'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "➣ قفل هشتگ", callback_data='BlackTeaM'}, 
			{text = lock_hashtags, callback_data="/lockhashtags:"..GP_id}
		},
		{
			{text = "➣ قفل ورود", callback_data='BlackTeaM'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "➣ قفل پیام های مکرر", callback_data='BlackTeaM'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "➣ قفل هرزنامه", callback_data='BlackTeaM'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "➣ قفل فراخوانی", callback_data='BlackTeaM'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "➣ قفل فارسی", callback_data='BlackTeaM'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "➣ قفل انگلیسی", callback_data='BlackTeaM'}, 
			{text = english, callback_data="/lockeng:"..GP_id}
		},
		{
			{text = "➣ قفل صفحات وب", callback_data='BlackTeaM'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "➣ قفل فونت", callback_data='BlackTeaM'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "➣ قفل سنجاق کردن", callback_data='BlackTeaM'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "➣ قفل ربات ها", callback_data='BlackTeaM'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		...
		{
			{text = "➣ قفل فحش", callback_data='BlackTeaM'}, 
			{text = fosh, callback_data="/lockfosh:"..GP_id}
		},
		{
			{text = "➣ قفل تبلیغات", callback_data='BlackTeaM'}, 
			{text = ads, callback_data="/lockads:"..GP_id}
		},
		{
			{text = "➣ قفل تبچی", callback_data='BlackTeaM'}, 
			{text = lock_tabchi, callback_data="/locktabchi:"..GP_id}
		},
		{
			{text = "➣ قفل یوزرنیم", callback_data='BlackTeaM'}, 
			{text = lock_username, callback_data="/lockusername:"..GP_id}
		},
		{
			{text = "➣ قفل اموجی", callback_data='BlackTeaM'}, 
			{text = emoji, callback_data="/lockemoji:"..GP_id}
		},
		{
			{text = "➣ قفل بنر", callback_data='BlackTeaM'}, 
			{text = views, callback_data="/lockviews:"..GP_id}
		},
		...
		{
			{text = "➣ خوشآمد گویی", callback_data='BlackTeaM'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   elseif lang then
	 text = '_به لیست قفل رسانه خوش امدید_'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "➣ قفل چت", callback_data='BlackTeaM'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "➣ قفل گیف", callback_data='BlackTeaM'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "➣ قفل متن", callback_data='BlackTeaM'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "➣ قفل اینلاین", callback_data='BlackTeaM'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "➣ قفل بازی", callback_data='BlackTeaM'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "➣ قفل عکس", callback_data='BlackTeaM'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "➣ قفل فیلم", callback_data='BlackTeaM'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "➣ قفل اهنگ", callback_data='BlackTeaM'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "➣ قفل ویس", callback_data='BlackTeaM'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "➣ قفل استیکر", callback_data='BlackTeaM'}, 
			{text = mute_sticker, callback_data="/settingsticker:"..GP_id}
		},
		{
			{text = "➣ قفل مخاطب", callback_data='BlackTeaM'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "➣ قفل نقل قول", callback_data='BlackTeaM'}, 
			{text = settings.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "➣ قفل موقعیت", callback_data='BlackTeaM'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "➣ قفل فایل", callback_data='BlackTeaM'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "➣ قفل خدمات", callback_data='BlackTeaM'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "➣ قفل کیبورد", callback_data='BlackTeaM'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = '> بازگشت ', callback_data = '/option:'..GP_id}
...
local lang = redis:get(hash) 
	...
	if not is_mod1(matches[2], msg.from.id) then
     if not lang then
		get_alert(msg.cb_id, "You Are Not Moderator✖️")
   elseif lang then
   ...
   elseif lang then
	...
	if not is_mod1(matches[2], msg.from.id) then
     if not lang then
		get_alert(msg.cb_id, "You Are Not Moderator✖️")
   elseif lang then
		get_alert(msg.cb_id, "✖️شما دسترسی ندارید")
   end
	else
    redis:del(hash)
   sleep(1)
   ...
   elseif lang then
    ...
    if not lang then
		...
		keyboard.inline_keyboard = {
			...
			{
				{text = "➣ Group Linkℹ️", callback_data="/link:"..matches[2]},
			...
			{ 
				{text = "➣ Back To Panel", callback_data="/option:"..matches[2]}
			}
		}
   elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			...
			{
				{text = "➣ لینک گروهℹ️", callback_data="/link:"..matches[2]},
			...
			{ 
				{text = "➣ بازگشت به پنل", callback_data="/option:"..matches[2]}
			}
		}
  end
		edit_inline(msg.message_id, text, keyboard)
...
if matches[1] == '/Black' then
	...
	keyboard.inline_keyboard = {
		{
			{text = "➣ 1", callback_data="/1:"..matches[2]}
		},
		{
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "➣ مهدی", callback_data="/1:"..matches[2]}
		},
		{
...
local text = [[]]
  if not lang then
		...
		keyboard.inline_keyboard = {
			{
				{text = "➣ Back 🔙", callback_data="/Black:"..matches[2]}
			}
		}
  elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "➣ بازگشت 🔙", callback_data="/Black:"..matches[2]}
			}
		}
  end
    edit_inline(msg.message_id, text, keyboard)
